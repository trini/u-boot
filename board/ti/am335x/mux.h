...
/* Ethernet0 */
#define	MII1_TXEN_PAD_CTRL_OFFSET	0x914
#define	MII1_RXDV_PAD_CTRL_OFFSET	0x918
#define	MII1_TXD3_PAD_CTRL_OFFSET	0x91c
#define	MII1_TXD2_PAD_CTRL_OFFSET	0x920
#define	MII1_TXD1_PAD_CTRL_OFFSET	0x924
#define	MII1_TXD0_PAD_CTRL_OFFSET	0x928
#define	MII1_TXCLK_PAD_CTRL_OFFSET	0x92c
#define	MII1_RXCLK_PAD_CTRL_OFFSET	0x930
#define	MII1_RXD3_PAD_CTRL_OFFSET	0x934
#define	MII1_RXD2_PAD_CTRL_OFFSET	0x938
#define	MII1_RXD1_PAD_CTRL_OFFSET	0x93c
#define	MII1_RXD0_PAD_CTRL_OFFSET	0x940
#define	MII1_REFCLK_PAD_CTRL_OFFSET	0x944
#define	MDIO_DATA_PAD_CTRL_OFFSET	0x948
#define	MDIO_CLK_PAD_CTRL_OFFSET	0x94c

/* Ethernet1 */
#define	GPMC_A0_PAD_CTRL_OFFSET		0x840
#define	GPMC_A1_PAD_CTRL_OFFSET		0x844
#define	GPMC_A2_PAD_CTRL_OFFSET		0x848
#define	GPMC_A3_PAD_CTRL_OFFSET		0x84c
#define	GPMC_A4_PAD_CTRL_OFFSET		0x850
#define	GPMC_A5_PAD_CTRL_OFFSET		0x854
#define	GPMC_A6_PAD_CTRL_OFFSET		0x858
#define	GPMC_A7_PAD_CTRL_OFFSET		0x85c
#define	GPMC_A8_PAD_CTRL_OFFSET		0x860
#define	GPMC_A9_PAD_CTRL_OFFSET		0x864
#define	GPMC_A10_PAD_CTRL_OFFSET	0x868
#define	GPMC_A11_PAD_CTRL_OFFSET	0x86c
#define	MII1_COL_PAD_CTRL_OFFSET	0x908
