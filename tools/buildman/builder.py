...
class Builder:
    ...
    Public members: (many should ->private)
        ...
        no_output: Do not keep any generated files from the build
    ...
    def __init__(self, toolchains, base_dir, git_dir, num_threads, num_jobs,
                 ...
                 work_in_output=False, show_bloat=False, no_outputs=False,
        ...
        if self.num_threads:
            ...
            self._single_builder = builderthread.BuilderThread(
                self, -1, mrproper, per_board_out_dir, show_bloat, no_outputs)
